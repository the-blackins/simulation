...
class SimulationEngine:
    ...
    def calculate_performance(self, student):
        ...
        institutional_impact = (self.calculate_factor_impact(student.simulation.institutional_factors) 
                              if student.university and student.simulation.institutional_factors else 1.0)
